...
/**
 * A proxy for a dynamic com.mysql.cj.api.jdbc.JdbcConnection implementation that provides failover features for list of hosts. Connection switching occurs on
