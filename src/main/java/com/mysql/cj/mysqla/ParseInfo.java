...
public class ParseInfo {
    ...
    public ParseInfo(String sql, MysqlaSession session, String encoding) {
        this(sql, session, encoding, true);
    }

    public ParseInfo(String sql, MysqlaSession session, String encoding, boolean buildRewriteInfo) {
    ...
    private void buildRewriteBatchedParams(String sql, MysqlaSession session, String encoding) {
