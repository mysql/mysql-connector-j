...
import com.mysql.cj.api.x.protocol.MessageConstants;
...
public class SyncMessageReader implements MessageReader {
    ...
    public Class<? extends GeneratedMessage> getNextMessageClass() {
        ...
        if (messageClass == null) {
            ...
            throw new XDevAPIError(readAndParse((Parser<Error>) MessageConstants.MESSAGE_CLASS_TO_PARSER.get(Error.class)));
        }
