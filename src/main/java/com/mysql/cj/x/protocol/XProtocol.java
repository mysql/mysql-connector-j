...
package com.mysql.cj.x.protocol;
...
import com.mysql.cj.api.x.protocol.MessageListener;
import com.mysql.cj.api.x.protocol.MessageReader;
import com.mysql.cj.api.x.protocol.MessageWriter;
import com.mysql.cj.api.x.protocol.ResultListener;
import com.mysql.cj.api.x.protocol.XpluginStatementCommand;
...
public class XProtocol implements Protocol {
    ...
    public CompletableFuture<SqlResult> asyncExecuteSql(String sql, Object args, String metadataCharacterSet, TimeZone defaultTimeZone) {
        ...
        com.mysql.cj.api.x.protocol.MessageListener l = new SqlResultMessageListener(f,
