 ...
 * <pre>if (reader.getNextMessageClass() == MessageType1.class) {
...
public interface MessageReader {
     ...
     * @throws MysqlxError if an <i>Error</i> message is received from the server
     */
     ...
     * @throws MysqlxError if an <i>Error</i> message is received from the server
     * @throws CJCommunicationsException wrapping an {@link IOException} during read or parse
     */
