...
public class PropertyDefinitions {
    ...
    static {
        PropertyDefinition<?>[] pdefs = new PropertyDefinition<?>[] { new BooleanPropertyDefinition(PNAME_paranoid, NO_ALIAS, DEFAULT_VALUE_FALSE,
                ...
                new StringPropertyDefinition(PNAME_profilerEventHandler, NO_ALIAS, LoggingProfilerEventHandler.class.getName(), RUNTIME_MODIFIABLE,
                ...
                new StringPropertyDefinition(PNAME_clientInfoProvider, NO_ALIAS, CommentClientInfoProvider.class.getName(), RUNTIME_MODIFIABLE,
                ...
                new StringPropertyDefinition(PNAME_loadBalanceExceptionChecker, NO_ALIAS, StandardLoadBalanceExceptionChecker.class.getName(),
                ...
                new StringPropertyDefinition(PNAME_socketFactory, NO_ALIAS, StandardSocketFactory.class.getName(), RUNTIME_MODIFIABLE,
                ...
                new IntegerPropertyDefinition(PNAME_socksProxyPort, NO_ALIAS, SocksProxySocketFactory.SOCKS_DEFAULT_PORT, RUNTIME_MODIFIABLE,
                ...
                new BooleanPropertyDefinition(PNAME_tcpNoDelay, NO_ALIAS, Boolean.valueOf(StandardSocketFactory.TCP_NO_DELAY_DEFAULT_VALUE).booleanValue(),
                        RUNTIME_MODIFIABLE, Messages.getString("ConnectionProperties.tcpNoDelay"), "5.0.7", CATEGORY_NETWORK, Integer.MIN_VALUE),

                new BooleanPropertyDefinition(PNAME_tcpKeepAlive, NO_ALIAS, Boolean.valueOf(StandardSocketFactory.TCP_KEEP_ALIVE_DEFAULT_VALUE).booleanValue(),
                        RUNTIME_MODIFIABLE, Messages.getString("ConnectionProperties.tcpKeepAlive"), "5.0.7", CATEGORY_NETWORK, Integer.MIN_VALUE),

                new IntegerPropertyDefinition(PNAME_tcpRcvBuf, NO_ALIAS, Integer.parseInt(StandardSocketFactory.TCP_RCV_BUF_DEFAULT_VALUE), RUNTIME_MODIFIABLE,
                        Messages.getString("ConnectionProperties.tcpSoRcvBuf"), "5.0.7", CATEGORY_NETWORK, Integer.MIN_VALUE, 0, Integer.MAX_VALUE),

                new IntegerPropertyDefinition(PNAME_tcpSndBuf, NO_ALIAS, Integer.parseInt(StandardSocketFactory.TCP_SND_BUF_DEFAULT_VALUE), RUNTIME_MODIFIABLE,
                        Messages.getString("ConnectionProperties.tcpSoSndBuf"), "5.0.7", CATEGORY_NETWORK, Integer.MIN_VALUE, 0, Integer.MAX_VALUE),

                new IntegerPropertyDefinition(PNAME_tcpTrafficClass, NO_ALIAS, Integer.parseInt(StandardSocketFactory.TCP_TRAFFIC_CLASS_DEFAULT_VALUE),
                ...
                new StringPropertyDefinition(PNAME_defaultAuthenticationPlugin, NO_ALIAS, MysqlNativePasswordPlugin.class.getName(), RUNTIME_MODIFIABLE,
