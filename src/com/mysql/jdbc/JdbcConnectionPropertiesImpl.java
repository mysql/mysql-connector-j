...
import com.mysql.core.conf.LongConnectionProperty;
import com.mysql.core.conf.MemorySizeConnectionProperty;
import com.mysql.core.conf.StringConnectionProperty;
import com.mysql.core.io.SocksProxySocketFactory;
import com.mysql.core.io.StandardSocketFactory;
import com.mysql.core.log.StandardLogger;
import com.mysql.core.util.PerVmServerConfigCacheFactory;
...
public class JdbcConnectionPropertiesImpl extends CommonConnectionProperties implements Serializable, JdbcConnectionProperties {
    ...
    static {
        try {
            java.lang.reflect.Field[] declaredFields = JdbcConnectionPropertiesImpl.class.getDeclaredFields();
            ...
            declaredFields = JdbcConnectionPropertiesImpl.class.getSuperclass().getDeclaredFields();
    ...
    private StringConnectionProperty loadBalanceExceptionChecker = new StringConnectionProperty("loadBalanceExceptionChecker",
            StandardLoadBalanceExceptionChecker.class.getName(), null, Messages.getString("ConnectionProperties.loadBalanceExceptionChecker"), "5.1.13",
    ...
    public BooleanConnectionProperty traceProtocol = new BooleanConnectionProperty("traceProtocol", false,
