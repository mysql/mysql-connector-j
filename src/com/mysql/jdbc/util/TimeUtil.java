...
public class TimeUtil {
    ...
    private static final String TIME_ZONE_MAPPINGS_RESOURCE = "/com/mysql/jdbc/util/TimeZoneMapping.properties";
    ...
    public final static Date fastDateCreate(boolean useGmtConversion, Calendar gmtCalIfNeeded, Calendar cal, int year, int month, int day) {
    ...
    public final static Date fastDateCreate(int year, int month, int day, Calendar targetCalendar) {
    ...
    public final static Timestamp fastTimestampCreate(boolean useGmtConversion, Calendar gmtCalIfNeeded, Calendar cal, int year, int month, int day, int hour,
    ...
    public final static Timestamp fastTimestampCreate(TimeZone tz, int year, int month, int day, int hour, int minute, int seconds, int secondsPart) {
